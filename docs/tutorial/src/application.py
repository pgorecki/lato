...
from notifications import notifications, NotificationService
from analytics import analytics, TodosCounter
...
def create_app() -> Application:
    ...
    def analytics_middleware(ctx: TransactionContext, call_next: Callable) -> Any:
        ...
        print(f" todos stats: {todos_counter.completed_todos}/{todos_counter.created_todos}")
        return result
